...
import com.example.pokedex.network.model.pokemonAtributes.TypeX

@Composable
fun PokemonListItem(modifier: Modifier = Modifier, pokemon: Pokemon) {
    Card(
        modifier = modifier,
        backgroundColor = backgroundColor(pokemon.types[0].type)
    ) {
...
fun backgroundColor(pokemonType: TypeX): Color {
